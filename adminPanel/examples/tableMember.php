            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Edit Member Table List</h4>
                  <p class="card-category"> Here is a subtitle for member table</p>
                </div>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        while($row=mysqli_fetch_array($res))
                        {
                          echo "<tr>";
                            echo "<td>";?>
                            <a href='deleteMember.php?id=<?php echo $row["user_id"]; ?>'><button type='button' class='btn btn-danger'>Delete</button></a>
                            <?php echo "</td>";

                            echo "<td>";?>
                            <a href='editMember.php?id=<?php echo $row["user_id"]; ?>'><button type='button' class='btn btn-success'>Edit</button></a>
                            <?php echo "</td>";

...
<body class="">
            ...
            <div class="col-md-10">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title "><?php echo $firstname;?> <?php echo $lastname; ?>'s Week 4 Progression Table</h4>
                  ...
                  <div class="table-responsive">
                    <form action="" name="form1" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter W4G1 resuslt" name="user_W4G1"  value="<?php echo $W4G1; ?>">
                      </div>

                      <div class="form-group">
                        <label for="pwd">W4G2</label>
                        <input type="text" class="form-control" placeholder="Enter W4G2 resuslt" name="user_W4G2"  value="<?php echo $W4G2; ?>">
                      </div>
  ...
  <script>
    ...
    if(isset($_POST["update"]))
    {
      ...
      user_W4G1='$_POST[user_W4G1]', user_W4G2='$_POST[user_W4G2]' where user_id=$id");
      ?>
      <script type="text/javascript">
      window.location.href = "tableActivityW4.php";
      </script>
      <?php
    }
     ?>

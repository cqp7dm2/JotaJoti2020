            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Edit Admin Table List</h4>
                  <p class="card-category"> Here is a subtitle for admin table</p>
                </div>
                <div class="col-md-2">
                  <a href="insertAdmin.php"><button type="submit" name="insertAdmin" class="btn btn-default">Add New Admin</button></a>
                </div>
                <div class="card-body">

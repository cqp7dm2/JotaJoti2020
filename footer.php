  ...
  <body>
    ...
    <!--<footer class="footer py-4">
      <div class="container" style="height: 50px;">
        <div class="row align-items-center mb-5">
          <div class="col-lg-3 text-lg-left">Logo</div>
    ...
    <footer class="footer-bs">
        <div class="row">
            ...
            <li><a href="#"><h4 style="color: #fff;">Terms and Condition</h4></a></li>
            <li><a href="#"><h4 style="color: #fff;">FAQ</h4></a></li>
            <li><a href="#"><h4 style="color: #fff;">Cookies Policy</h4></a></li>
            <li><a href="#"><h4 style="color: #fff;">Privacy Policy</h4></a></li>
            <li><a href="#"><h4 style="color: #fff;">Terms of Use</h4></a></li>
          </div>
        </div>
    </footer>
                  ...
                  <!-- <div class="col-lg-3 text-lg-left">
                    ...
                    <div class="row pt-6">
                      <ul class="font-weight-bold pt-3" style="list-style-type: none;">
                        ...
                        <li><a href="faq.php" target="_blank" style="font-size: 13px; color: #fff;">FAQ</a></li>

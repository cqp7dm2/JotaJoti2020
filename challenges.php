          ...
          <div class="row">
            <div class="col-md-6">
              <div class="icon-box hover-div">
                ...
                <p class="futura">
                    1)	Participants have to create a poster with to promote and attract more people to join Jota-Joti 2020. <br>
                    ...
                    5)	Method of creating is not limited. (Hand drawing OR Online editing) <br>
                    6)	Embezzlement of previous or existing designs OR posters is prohibited. <br>
                </p>
              </div>
            </div>
            <div class="col-md-6 mt-4 mt-md-0">
              <div class="icon-box hover-div">
                ...
                <p class="futura">
                    1)	Total of 30 questions. <br>
                    2)	The questions are automatically shuffled for participants. <br>
                    3)	Participants are given 30 seconds to answer the question and every question answer correctly will earn 5 seconds extension in the answering time. <br>
            ...
            <div class="col-md-6 mt-4 mt-md-0">
              <div class="icon-box hover-div">
                ...
                <p class="futura">
                    ...
                    3)	As for Phonetics Alphabets, questions OR statements are given in phonetics alphabets, participants have to answer or translate into words. <br>
            ...
            <div class="col-md-6 mt-4 mt-md-0">
              <div class="icon-box hover-div">
                ...
                <p class="futura">
                    1)	Participants are required to collect 10 JID codes for other participants all around the world. <br>
          ...
          <div class="row">
            ...
            <div class="col-md-6 mt-4 mt-md-0">
              <div class="icon-box hover-div">
                ...
                <h4><a>Pac-man</a></h4>
                <p class="futura">
                    1)	Specific points are required to reach or excess to be consider as completed the challenge. <br>
                    2)	There is a leader board showing rankings, thus, try the best to reach the top <br>
                    3)	Participants are allowed to play as many times as they desire.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-6 mt-4 mt-md-0">
              <div class="icon-box hover-div">
                ...
                <p class="futura">
                    1)	Specific points are required to reach or excess to be consider as completed the challenge. <br>
                    2)	There is a leader board showing rankings, thus, try the best to reach the top <br>
                    3)	Participants are allowed to play as many times as they desire. </p>
              </div>
            </div>
            <div class="col-md-6 mt-4 mt-md-0">
              <div class="icon-box hover-div">

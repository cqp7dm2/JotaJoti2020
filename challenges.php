                ...
                <div class="tab-pane active show" id="tab-1">
                  ...
                  <div class="row futura">
                      <p> 1) You need to have an email account to participate. <br>
                          ...
                          6) After 2 weeks, the challenge will be closed. (eg. the 2 challenges published on the first week will be closed on the 3rd week) <br>
                          ...
                          10) The TOP 10 fastest to submit all 8 completion cards will win our JOTA-JOTI badge. (Note: There are 2 TOP 10 winners which are TOP 10 scouts/guides aged below 12 and TOP 10 scouts/guides aged above12) <br>
          ...
          <div class="row">
            ...
            <div class="col-md-6 mt-4 mt-md-0">
              <div class="icon-box hover-div">
                ...
                <p class="futura">
                  1) Total of 30 questions and all must be answered. <br>

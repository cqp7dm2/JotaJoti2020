       ...
       ?>
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-1">Rider</h3>
            </div>
        </div>
                    ...
                    <!--Display in html table-->
                      ...
                      <?php
                            ...
                            while($rows = mysqli_fetch_array($result))
                            {
                              ...
                              echo"<td>".$rows['user_Pnumber']."</td>";
                              echo"<td>".$rows['user_address']."</td>";
                              echo"<td>".$rows['user_postalcode']."</td>";
                              echo"<td>".$rows['user_dob']."</td>";

                              //Create delete button to delete the user information from the databased

                              echo "<td><a href='userdelete.php?id=".$rows['user_id']."'><button>Delete</button></a></td>";
                              echo "</tr>";
                            }
                       ?>
                    </table>

        ...
        <div class="container">
          ...
          <div class="row col-lg-12">
            <p class="futura"> The contest is open to scouts and guides age below 12. <br>
                                The registration fees is MYR 5. <br>
                                We will post the design to vote at our Facebook Pages from 10<sup>th</sup>, October 2020 to 15<sup>th</sup>, October 2020. <br>
                  ...
                  <div class="row">
                    <div class="col-lg-11 details order-2 order-lg-1">
                      ...
                      <p class="futura"> ●	Your design must follow the PDF file we provided.
                                        (We will provide the link for download the design template)<br>
                ...
                <div class="tab-pane" id="gcb-4">
                  <div class="row">
                    <div class="col-lg-11 details order-2 order-lg-1">
                      ...
                      ● However if the video is taken down by Facebook due to copyright issues, the organizing committees will not bear responsibility for entries that are not received or posted for whatever reason. <br>
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <!-- <section class="page-section" id="services">
        <div class="container">
          ...
          <p class="futura">
            ...
            2)	RULES :<br>
              ●	Kindly contact the in-charge person of particular competition for any enquiries. Facebook URL: www.facebook.com/huishien99/ |  Email: huishienchong@gmail.com.<br>
              ●	Each team has to submit 2 FUNNY & CREATIVE group photos of the team related to the theme “MY CULTURAL IDENTITY” along with one CREATIVE photo caption for each photo submitted.<br>
              ●	Participants are allowed to wear whatever costume they want, as long as the costumes are appropriate. Anyway, participants are encouraged to wear a scout scarf in the group photos.<br>
              ●	Photos resolution required : 1920*768, minimum 300 dpi.<br>
              ●	Photo collage, photo editing, and any other reasonable and appropriate visual effects can be used in the photos submitted.<br>
            ...
            3)	DEADLINE:<br>
              ●	The deadline for submission of songs is 1159 hours (+8 GMT) 9th, October 2020. Submissions received after this deadline will not be reviewed or rated by the judging panel.<br><br>
